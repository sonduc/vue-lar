        ...
        <div class="row">
          ...
          <div class="col-md-9">
            <div class="form-group row">
              ...
              <label for="city" class="col-sm-1 col-form-label" style="padding-left: inherit;">Thành phố</label>
              <div class="col-sm-2">
    ...
    <div class="row">
      <div class="col-sm-12">
        <div>
          ...
          <gmap-map ref="map" :center="center" :zoom="6" :options="{ minZoom:6, maxZoom:18 }" style="width:100%; height: 830px;"
            @idle="onIdle">
            <gmap-marker :key="index" v-for="(m, index) in markers" :position="m.latLng" :clickable="true" :draggable="false"
              :icon="getIcon(m)" @mouseover="toggleInfoWindow(m,index)"></gmap-marker>
